...
const Dashboard02 = () => {
      ...
      <>
        {menu?.submenus
          ...
          <div key={menu.title} className='relative group mb-2'>
            <div className={`${expanded ? 'lg:w-60' : 'lg:w-8 group-hover:lg:w-60 lg:bg-sky-400 rounded duration-200 group-hover:lg:shadow'} text-white flex flex-col p-2 whitespace-nowrap`}>
  ...
  return (
    <div className='h-screen flex'>
      <div className={`fixed top-0 left-0 h-screen lg:static lg:translate-x-0 w-64 p-2 z-20 ${expanded ? 'lg:w-64' : 'lg:w-12'} ${openSidebar ? 'translate-x-0' : '-translate-x-full'} flex flex-col duration-500 bg-sky-900 shadow`}>
        <Link to='/'>
          <div className={`${expanded ? 'lg:w-60' : 'lg:w-8'} flex items-center px-2 whitespace-nowrap text-white`}>
        ...
        <div className='flex flex-col mt-2 text-white'>
          ...
          <div className='flex'>
            <img src="https://randomuser.me/api/portraits/men/46.jpg" alt="" className={`rounded object-cover duration-500 h-16 w-16 ${expanded ? 'lg:h-16 w-16' : 'lg:h-8 w-8'}`} />
      ...
      <div className='flex-1 overflow-scroll'>
        <div className='fixed h-12 w-full flex justify-between items-center p-2 bg-white z-10'>
          <button className='invisible lg:visible' onClick={() => setExpanded(!expanded)}><RiBarChartHorizontalLine /></button>
          <button className='visible lg:invisible' onClick={() => setOpenSidebar(!openSidebar)}><RiBarChartHorizontalLine /></button>
        </div>
